    ...
    return (
        <div>
            <div className="row">
                ...
                <div>
                    Sort by {' '}
                    <select className="select-size" value={order} onChange={(e) => {navigate(getFilterUrl({order: e.target.value}))}}>
                ...
                <div className="col-1">
                    ...
                    <div>
                        ...
                        <ul>
                            {prices.map((p) =>
                                <li key={p.name}>
                                    <Link to={getFilterUrl({min: p.min, max: p.max})} className={`${p.min}-${max}` === `${min}-${max}` ? 'active' : ''}>
                                        {p.name}
                                    </Link>
                                </li>
                            )}
